...
const Navigation: React.FC = () => (
  <nav className="navbar">
    <div className="nav-links">
      <Link to="/" className="nav-link button button-animated">Home</Link>
      <Link to="/services" className="nav-link button button-animated">Marketplace</Link>
      <Link to="/services" className="nav-link button button-animated">Swift Transfer</Link>
      <Link to="/login" className="nav-link button button-animated">Login</Link>
    </div>
  </nav>
);
        ...
        <main className="main-content">
          <Routes>
            <Route
              ...
              element={
                <section>
                  <h2 className="section-subtitle">Empowering Digital Economies</h2>
            ...
            <Route path="/swift transfer" element={<p>Add Request Page (Coming Soon)</p>} />
